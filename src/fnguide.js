...
class Puppet {
  ...
  async massIndexCrawl(date) {
    ...
    let indexURL = URL.API.index.format(date)
  ...
  async massOHLCVCrawl(date) {
    ...
    // let indexURL = URL.API.index.format(this.todayDate)
    let ohlcvURL = URL.API.ohlcv.format(date)
  ...
  async massBuysellCrawl(date) {
    ...
    let buysellURL = URL.API.buysell.format(date)
  ...
  async massFactorCrawl(date) {
    ...
    let factorURL = URL.API.factor.format(date)
